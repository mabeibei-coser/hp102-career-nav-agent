...
const TOOL_DEFS: NeutralTool[] = [
  {
    ...
    description:
      "展示当前步骤卡片。首次展示档案卡仅限用户明确要求开始测评、填写档案或生成职业导航报告；普通咨询、自我介绍、询问测评是什么时不要调用。已有卡片后，用户明确要求继续当前流程或重看卡片时可调用；意图不清楚先用文字澄清。",
    parameters: { type: "object", properties: {} },
  },
  {
    name: "propose_profile",
    description:
      "仅在用户明确要求填写档案，或已有档案卡且用户正在补充、修改档案时，把明确说出的字段填入档案确认卡，供用户检查后自己点击确认。普通自我介绍或咨询中提到学历、经历不调用；不要猜测字段。",
    parameters: {
      type: "object",
      properties: {
        identity: {
